 ...
 */
public class ReallocateFreeslotAsync extends AsyncTask<String, Void, String> {
    private OnService onService;
    private Context mContext;

    public ReallocateFreeslotAsync(Context mContext, OnService onService) {
    ...
    protected String doInBackground(String... arg0) {
        ...
        try {
            ...
            URL url = new URL("http://mymlcp.co.in/android/reserve_slot_in_freeslots.php");
