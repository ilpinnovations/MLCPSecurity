 ...
 */
public class SearchVehicleAsync extends AsyncTask<String, Void, String> {
    private OnService onService;
    private Context mContext;

    public SearchVehicleAsync(Context mContext, OnService onService) {
    ...
    protected String doInBackground(String... arg0) {
        ...
        try {
            ...
            URL url = new URL("http://mymlcp.co.in/android/search_vehicle.php");
            Map<String, Object> params = new LinkedHashMap<>();
            params.put("vehicle_no", param1);
