 ...
 */
public class TagVehiclesToSlotAsync extends AsyncTask<String, Void, String> {
    private OnService onService;
    private Context mContext;

    public TagVehiclesToSlotAsync(Context mContext, OnService onService) {
    ...
    protected String doInBackground(String... arg0) {
        ...
        try {
            ...
            URL url = new URL("http://mymlcp.co.in/android/tag_vehicles_to_slot.php");
